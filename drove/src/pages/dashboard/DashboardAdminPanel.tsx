...
const DashboardAdminPanel: React.FC = () => {
  ...
  return (
    <div className="flex flex-col w-full space-y-6 md:space-y-8 pt-20">
      {/* Header + Título */}
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center w-fit lg:w-full mx-auto gap-4 mb-2 md:mb-4 ">
        <div className="text-center">
          <h1
            className="text-2xl md:text-3xl font-bold mb-2 lg:text-start"
        ...
        <div className="flex gap-3 mx-auto lg:mx-0">
          <Button variant="outline" size="sm" asChild>
            <Link to="/admin/traslados">Ver Todos los Traslados</Link>
          </Button>
        </div>
      </div>

      {/* Métricas principales */}
      <div className="grid grid-cols-2 xl:grid-cols-5 gap-4 md:gap-6 animate-fade-in">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-orange-400 font-semibold">
                      {metrics?.pendingUsersCount} usuarios pendientes
                    </p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-red-400 font-semibold">
                      {metrics?.pendingPaymentsCount} pagos pendientes
                    </p>
                    <p className="text-white/70 text-sm">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-blue-400 font-semibold">
                      {metrics?.pendingInvoicesCount} facturas pendientes
                    </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8 w-full animate-fade-in">
        <div className="lg:col-span-2">
          <Card className="bg-white/10 border-white/20 h-full shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col justify-between">
            <CardHeader>
            ...
            <CardContent className="space-y-7">
              ...
              <div className="flex justify-between items-center">
                ...
                <span
                  ...
                  style={{ fontFamily: "Helvetica" }}
                >
                  {metrics?.reviews.average > 0
                    ? metrics?.reviews.average.toFixed(2)
                    : "0.00"}{" "}
                  €
                </span>
              </div>
              <div className="w-full bg-white/10 rounded-full h-2 mt-1">
                <div
                  ...
                  style={{
                    width: `${Math.min(
                      (metrics?.completedTransfers /
                        Math.max(metrics?.totalTransfers, 1)) *
                        100,
                      100
                    )}%`,
                  }}
              ...
              <p className="text-white/60 text-sm">
                {metrics?.totalTransfers > 0
                  ? (
                      (metrics?.completedTransfers / metrics?.totalTransfers) *
                      100
                    ).toFixed(1)
                  : "0"}
                % de traslados completados
              </p>
            </CardContent>
          </Card>
        </div>
        ...
        <Card className="bg-white/10 border-white/20 shadow-lg hover:shadow-xl transition-shadow duration-300">
          ...
          <CardContent className="space-y-3">
            <Button
              variant="ghost"
              size="sm"
              className="w-full justify-center rounded-2xl border transition-all-300 border-white/20"
              asChild
            >
      ...
      <Card className="bg-white/10 border-white/20 shadow-lg hover:shadow-xl transition-shadow duration-300 animate-fade-in">
        <CardHeader>
          <CardTitle className="flex items-center justify-between gap-3 text-white">
            <span className="max-w-30" style={{ fontFamily: "Helvetica" }}>
              Traslados Recientes
            </span>
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <div>
              ...
              <p className="text-white/80">
                ...
                {metrics?.completedTransfers} traslados completados con éxito.
              </p>
            </div>
          </div>
        </CardContent>
