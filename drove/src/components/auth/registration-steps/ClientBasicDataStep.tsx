...
import { RegistrationFormData, ClientFormData } from '@/types/new-registration';
...
const ClientBasicDataStep: React.FC<Props> = ({ data, onUpdate, onNext, onPrevious }) => {
  const clientData = data as Partial<ClientFormData>;
    ...
    <div>
      <div className="text-center mb-8">
        ...
        <p className="text-white/70">
          Completa la información básica de tu cuenta
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          <Label htmlFor="companyName" className="text-white/80 mb-2 block">
          ...
          <div className="relative">
            ...
            <Input
              id="companyName"
              type="text"
              placeholder="Ej: Rent a Car Madrid S.L."
              value={formData.companyName}
              onChange={(e) => handleChange('companyName', e.target.value)}
              className="pl-12 bg-white/5 border-white/20 text-white"
            />
          </div>
        </div>
...
export default ClientBasicDataStep;
