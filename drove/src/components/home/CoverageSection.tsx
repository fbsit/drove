  ...
  return (
    <section className="px-4 py-16 md:py-20">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col gap-12 items-start mb-16">
          {/* Mapa mejorado con arte DROVE */}
          <div className="relative w-full">
            <div className="bg-gradient-to-br from-drove-accent/20 to-drove-accent/5 rounded-2xl py-8 px-6 md:px-8 border border-drove-accent/20 flex items-center justify-center">

              {/* Section lightblue */}
              <div className="text-center flex flex-col md:flex-row flex-wrap gap-8 items-center w-full justify-evenly">
          ...
          <div className='w-full flex gap-8 flex-col xl:flex-row'>
            ...
            <div className='xl:w-1/2'>
              <h4 className="text-xl font-bold text-white mb-6 text-left">Y muchas más...</h4>
