...
interface MobileReceiverDetailsStepProps {
  form: UseFormReturn<VehicleTransferRequest>;
}

const MobileReceiverDetailsStep: React.FC<MobileReceiverDetailsStepProps> = ({ form }) => {
  return (
...
export default MobileReceiverDetailsStep;
